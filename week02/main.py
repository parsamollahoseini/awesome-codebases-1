...
try:
    ...
    print("Error: Combat strength must be a valid integer.")
    exit()
...
healingPotion = random.choice([0, 1])  # Randomly determine if a healing potion is found (1 = found, 0 = not found)
